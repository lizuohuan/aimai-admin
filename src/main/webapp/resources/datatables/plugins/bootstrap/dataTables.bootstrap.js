    ...
    "bootstrap_full_number": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                '<li class="prev disabled"><a href="#" title="上页"><i class="fa fa-angle-left"></i></a></li>' +
                '<li class="next disabled"><a href="#" title="下页"><i class="fa fa-angle-right"></i></a></li>' +
                '<li class="next disabled"><a href="#" title="末页"><i class="fa fa-angle-double-right"></i></a></li>' +
                '</ul>'
            );
            var els = $('a', nPaging);
            $(els[0]).bind('click.DT', {
