    ...
    <form class="layui-form" action="" id="formData" ng-controller="editBannerCtr" ng-cloak>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="tradeName" value="${tradeName}" lay-verify="required" placeholder="请输入行业名" autocomplete="off" class="layui-input" maxlength="50">
            </div>
        </div>
    ...
    webApp.controller("editBannerCtr", function($scope,$http,$timeout){
        ...
        layui.use(['form', 'layedit', 'laydate', 'upload', 'layedit'], function() {
            ...
            form.on('submit(demo1)', function(data) {
                AM.ajaxRequestData("post", false, AM.ip + "/trade/update", data.field , function(result) {
